...
class ProgressViewModel(
    private val repository: UserPreferencesRepository, private val gameRecordDao: GameRecordDao
) : ViewModel() {

    val highScore: StateFlow<Int> =
        repository.highScoreFlow.stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), 0)

    val bestStreak: StateFlow<Int> =
        repository.bestStreakFlow.stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), 0)
